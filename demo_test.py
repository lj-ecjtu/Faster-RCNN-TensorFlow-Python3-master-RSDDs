...
if __name__ == '__main__':
    ...
    tfmodel = os.path.join(cf.FLAGS2["root_dir"], 'Module', 'LJModule', 'Faster RCNN', demonet, 'RSDDs_2', 'default', NETS[demonet][0])
    ...
    output_path=os.path.join(os.path.dirname(__file__), 'mAP',"test_result\\RSDDs_2_train_test_nms\\RSDDs_train_test_20000_30000_0.1")
