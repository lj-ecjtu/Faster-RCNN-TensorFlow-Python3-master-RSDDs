...
def proposal_target_layer(rpn_rois, rpn_scores, gt_boxes, _num_classes):
    ...
    # cfg.FLAGS.proposal_use_gt=Flase
    ...
    # cfg.FLAGS.proposal_fg_fraction=0.25
    ...
    bbox_outside_weights = np.array(bbox_inside_weights > 0).astype(np.float32)   # bbox_inside_weights > 0 产生bool类型数组
...
def _get_bbox_regression_labels(bbox_target_data, num_classes):
    ...
    for ind in inds:
        ...
        bbox_inside_weights[ind, start:end] = cfg.FLAGS2["bbox_inside_weights"]   #FLAGS2["bbox_inside_weights"] = (1.0, 1.0, 1.0, 1.0)
    # (clss.size, 4 * num_classes)
